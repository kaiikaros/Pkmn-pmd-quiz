...
function submitQuiz() {
    ...
    let finalPokemon = candidates[0] || { name: "Default (Needs Mapping)", nature: winningNature };
    ...
    if (webhookUrl !== "https://discord.com/api/webhooks/1549032761501814835/U5HpO45TbdUdd0h6nHQXt3yjmG4uMOMBaKvN6Ct0olmuJz_iywfaMYkedAn0vsPzyuta") {
        fetch(webhookUrl, {
            method: "POST",
